...
### Neutral
- **Warm Paper** (oklch(0.9486 0.0165 79.35)): the main notebook ground. Creamy and clean, never sepia, stained, or vignetted. On the home hero it carries a sampled wall-paper texture (`src/assets/home/wall-white.webp`, tiled at 64rem) with the token color underneath as the load fallback. The texture is a material on an existing ground, not a new ground.
